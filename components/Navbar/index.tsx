...
export function Navbar() {
  return (
    <header className="md:w-[85%] w-screen md:z-40 sm:z-0 flex justify-center md:justify-between dark:bg-[#212121] fixed bg-white items-center py-3 px-5 z-30 border-none shadow-none">
